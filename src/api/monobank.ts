import { AccountModel, MonobankUserModel, endpointsTypes } from "shared-types";
...
export const refreshMonoAccounts = async (): Promise<AccountModel[]> =>
  api.get("/banks/monobank/refresh-accounts");
